...
> [!NOTE]
> You need to ensure the `MUSCLE` is downloaded and is set into the system PATH. Furthermore, you should change the MUSCLE execution file name to `muscle` which the code call this name to run MUSCLE.
---
